...
function MainBanner() {
  return (
    <section>
      <div className="relative w-full h-[calc(100vh-148px)] overflow-hidden ">
        <div className="absolute top-0 left-0 flex">
          <div className={`w-screen h-[calc(100vh-148px)] relative flex justify-center items-center`}>
            ...
            <div className="absolute text-white uppercase">
              <div className="text-7xl text-center leading-normal font-normal -tracking-tight">
